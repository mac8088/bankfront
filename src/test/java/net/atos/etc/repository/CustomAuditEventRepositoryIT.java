package net.atos.etc.repository;

import net.atos.etc.EtcApp;
import net.atos.etc.config.Constants;
import net.atos.etc.config.audit.AuditEventConverter;
import net.atos.etc.domain.PersistentAuditEvent;
...
import static net.atos.etc.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
