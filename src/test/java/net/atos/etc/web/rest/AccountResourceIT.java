package net.atos.etc.web.rest;

import net.atos.etc.EtcApp;
import net.atos.etc.config.Constants;
import net.atos.etc.domain.Authority;
import net.atos.etc.domain.PersistentToken;
import net.atos.etc.domain.User;
import net.atos.etc.repository.AuthorityRepository;
import net.atos.etc.repository.PersistentTokenRepository;
import net.atos.etc.repository.UserRepository;
import net.atos.etc.security.AuthoritiesConstants;
import net.atos.etc.service.MailService;
import net.atos.etc.service.UserService;
import net.atos.etc.service.dto.PasswordChangeDTO;
import net.atos.etc.service.dto.UserDTO;
import net.atos.etc.web.rest.errors.ExceptionTranslator;
import net.atos.etc.web.rest.vm.KeyAndPasswordVM;
import net.atos.etc.web.rest.vm.ManagedUserVM;
 ...
 */
@SpringBootTest(classes = EtcApp.class)
